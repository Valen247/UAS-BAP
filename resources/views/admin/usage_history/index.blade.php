                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nama</th><th>Date</th><th>Time</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($usage_history as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $usage_history->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
