<div class="form-group {{ $errors->has('oder_id') ? 'has-error' : ''}}">
    <label for="oder_id" class="control-label">{{ 'Oder Id' }}</label>
    <input class="form-control" name="oder_id" type="number" id="oder_id" value="{{ isset($order->oder_id) ? $order->oder_id : ''}}" >
    {!! $errors->first('oder_id', '<p class="help-block">:message</p>') !!}
</div>
